                ...
                <Container>
                  <Row>
                    {Array.from({
                      ...
                      <Col key={indeex}>
                        <Image width={200} className=" bg-body-secondary" src={productsPage[index].UrlImagen[indeex]} fluid />
                      </Col>
                    ))}
                  </Row>
                </Container>
              ...
              {Array.from({
                ...
                <td colSpan={1} key={indeeex}>
                  <tr>
                    <td>
                      Cod. Producto:
                      {productsPage[index].Especificaciones[indeeex].id.CodProducto}
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Color:{productsPage[index].Especificaciones[indeeex].id.Color}
                    </td>
                  </tr>
                  <tr>
                    <td>
                  ...
                  <tr>
                    <td>
                      Talle:{productsPage[index].Especificaciones[indeeex].id.Talle}
                    </td>
                  </tr>
                  <tr>
                    <td>
                      Stock:{productsPage[index].Especificaciones[indeeex].id.Stock}
                    </td>
                  </tr>
                  <tr>
                    <td>
